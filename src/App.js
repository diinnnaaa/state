      ...
      {productsList.map(product => (
        ...
        <div className='ftft'>
          ...
          <div className="body">
            ...
            {kop && <p className='description'>{product.description}</p>}
            {kop && <p className='discountPercentage'> {product.discountPercentage} </p>}
            {kop && <p className='rating'> {product.rating}</p> }
            {kop &&  <p className='stock'> {product.stock}</p>  }
            {kop && <p className='category'>{product.category}</p>}
